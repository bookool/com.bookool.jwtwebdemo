package com.bookool.jwtwebdemo.JWT;

import java.util.Date;
import java.util.HashMap;
import java.util.Map;

import com.bookool.jwtwebdemo.JWT.TokenState;
...
public class jwtpro {
	 ...
	 * 秘钥
	 */
	private static final byte[] SECRET = "3d990d2276917dfac04467df11fff26d"
			.getBytes();
	...
	public static String createToken(Map<String, Object> payload) {
		...
		JWSObject jwsObject = new JWSObject(header,
				new Payload(new JSONObject(payload)));
		try {
			// 将jwsObject 进行HMAC签名
